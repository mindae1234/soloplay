...
<script type="text/javascript">
    ...
    /* 	str = f.pwd.value;
    	...
    	f.pwd.value = str; */
    	f.action = "<%=cp%>/bbs/update_ok?boardNo=${ddddd.boardNo}";   
...
<div id="bbs">
	...
	<div id="bbsCreated">
		<div class="bbsCreated_bottomLine">
			<dl>
				<dt>제&nbsp;&nbsp;&nbsp;&nbsp;목</dt>
				<dd>
				      <input type="text" name="boardSubject" size="50" maxlength="100"  class="boxTF" value="${ddddd.boardSubject }" />
				</dd>
			</dl>
		</div>
		...
		<div class="bbsCreated_bottomLine">
			<dl>
				<dt>작성자</dt>
				<dd>
				      <input type="text" name="memberId" size="35" maxlength="20" class="boxTF" value="${ddddd.memberId }" readonly="readonly" />
				</dd>
			</dl>
		</div>
	...
	<%-- 	<div class="bbsCreated_bottomLine">
		...
		<div id="bbsCreated_content">
			<dl>
				<dt>내&nbsp;&nbsp;&nbsp;&nbsp;용</dt>
				<dd>
				      <textarea name="boardContent" cols="63" rows="12" class="boxTA">${ddddd.boardContent }</textarea>
				</dd>
			</dl>
		</div>
	...
	<div id="bbsCreated_footer">
		    ...
		    onclick="javascript:location.href='<%=cp%>/bbs/article?boardNo=${ddddd.boardNo}'"/>
	</div>
